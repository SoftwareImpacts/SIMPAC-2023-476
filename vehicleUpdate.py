...
class Ant:
    def __init__(self, graph: objUpdate, start_index=0):
        super()
        self.graph = graph
    ...
    @staticmethod
    def cal_total_travel_distance(graph: objUpdate, travel_path):
        distance = 0
    ...
    @staticmethod
    def local_search_once(graph: objUpdate, travel_path: list, travel_distance: float, i_start, stop_event: Event):
        depot_ind = []
